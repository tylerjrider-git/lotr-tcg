...
export const CARD_PREVIEW_SCALE_FACTOR = 3.0;
...
export const drawDeck = {
    x: playerHand.x + playerHand.width + Margin, y: playerHand.y,
    width: CARD_WIDTH, height: CARD_HEIGHT
}

export const discardPile = {
    x: drawDeck.x + drawDeck.width + 3*Margin, y: playerHand.y,
    width: CARD_WIDTH, height: CARD_HEIGHT
}
// Note the width is not used during drawing, only during snap calculations
export const companionZone = {
    x: supportZone.x, y: playerHand.y - (CARD_HEIGHT + Margin),
    width: (CARD_WIDTH+2*Margin)*9, height: playerHand.height
}
...
export const opponentDiscardPile = {
    x: opponentDeadPile.x + opponentDeadPile.width + Margin, y: OPPONENT_AREA_OFFSET,
    width: CARD_WIDTH, height: CARD_HEIGHT
}
